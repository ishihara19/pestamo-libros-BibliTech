...
class Settings:
    ...
    DISPONIBILIDAD_EJEMPLAR_DISPONIBLE_ID = int(os.getenv("DISPONIBILIDAD_EJEMPLAR_DISPONIBLE_ID",3))
    RESERVADO_EJEMPLAR_ID = int(os.getenv("RESERVADO_EJEMPLAR_ID",4))
    PRESTADO_EJEMPLAR_NO_DISPONIBLE_ID = int(os.getenv("PRESTADO_EJEMPLAR_NO_DISPONIBLE_ID",5))
    DAÑADO_EJEMPLAR_ID = int(os.getenv("DAÑADO_EJEMPLAR_ID",6))
settings = Settings()
